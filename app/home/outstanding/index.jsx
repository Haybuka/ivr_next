    ...
    <aside className={styles.outstanding}>
      ...
      <div className="md:w-[420px] my-10 md:my-0 md:py-28 md:px-10">
        <h3 className="text-xl capitalize  font-normal font-odor">
          ...
          <span className="text-ivr-100">Residential</span> and{' '}
          <span className="text-ivr-100">Commercial</span> services.
        </h3>
        ...
        <p className="static md:absolute md:top-2/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-2/2 bg-ivr-100 text-white py-3 px-6 text-black">
